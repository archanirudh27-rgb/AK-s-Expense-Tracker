(function(){
  ...
  function correctedBalance(){
    ...
    (typeof rows!=='undefined'?rows:[]).forEach(x=>{
      ...
      /* A reconciliation is treated as the closing balance for its selected date.
         Therefore every transaction dated on or before that date is already included
         in the reconciled amount, even if it was entered into FinTrack later.
         This prevents back-dated/same-day entries from being deducted twice. */
