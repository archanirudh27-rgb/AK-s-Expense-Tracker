const CACHE_NAME='fintrack-pwa-v34';
const SHELL=['./','./index.html','./manifest.webmanifest?v=34','./runtime-config.js?v=34','./fintrack-icon-192.svg?v=29','./fintrack-icon-512.svg?v=29'];
