const CACHE_NAME='fintrack-pwa-v47';
const SHELL=['./','./index.html','./manifest.webmanifest?v=43','./runtime-config.js?v=44','./savings-audit-v42.js?v=44','./home-chart-v45.js?v=47','./fintrack-icon-192.svg?v=35','./fintrack-icon-512.svg?v=35'];
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/runtime-config.js')){
    event.respondWith(fetch(event.request,{cache:'no-store'}).then(async response=>{
      ...
      if(!text.includes('home-chart-v45.js'))text+="\n(function(){if(!document.getElementById('fintrack-home-chart-loader')){var s=document.createElement('script');s.id='fintrack-home-chart-loader';s.src='./home-chart-v45.js?v=47';document.head.appendChild(s)}})();";
