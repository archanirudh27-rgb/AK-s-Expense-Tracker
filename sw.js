const CACHE_NAME='fintrack-pwa-v29';
const SHELL=['./','./index.html','./manifest.webmanifest?v=29','./runtime-config.js?v=29','./fintrack-icon-192.svg?v=29','./fintrack-icon-512.svg?v=29'];
